...
public:
	...
	{
		uint8_t ledPowerLevel = 0x2F; // Options: 0=Off to 255=50mA
		uint16_t sampleAverage = 2;	  // Options: 1, 2, 4, 8, 16, 32
		uint8_t ledMode = 3;		  // Options: 1 = Red only, 2 = Red + IR, 3 = Red + IR + Green
		uint16_t sampleRate = 3200;	  // Options: 50, 100, 200, 400, 800, 1000, 1600, 3200
	...
	static const uint16_t MAX_DATA_BUFFER_SIZE = 100;
